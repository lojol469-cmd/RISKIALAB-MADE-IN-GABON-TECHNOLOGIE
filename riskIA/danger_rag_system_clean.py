...
class PDFReportGenerator:
    ...
    def generate_complete_danger_study(self, analysis: Dict, output_path: str, reference_image_path: Optional[str] = None, installation_name: str = "", location: str = ""):
        """
        ...
        Args:
            ...
            location: Localisation de l'installation (input manuel)
        """
        ...
        # Page de garde
        story.extend(self._create_cover_page(complete_analysis, installation_name, location))
    ...
    def _create_cover_page(self, analysis: Dict, installation_name: str = "", location: str = "") -> List:
        ...
        final_location = location if location else analysis.get('location_context', 'Localisation à déterminer')

        elements.append(Paragraph(f"<b>Installation:</b> {final_installation_name}", self.styles['NormalText']))
        elements.append(Paragraph(f"<b>Localisation:</b> {final_location}", self.styles['NormalText']))
